...
fonction_simu_attrition_nofe <- function(nbsimu = 1, theta2_alpha_Gg, lambda1_alpha_St, sigma_alpha, sigma_epsilon){
...
for (simu_i in 1:nsims){
  ...
  for (t in 1:T){
    St_chaine[alpha[,t] > quantile(alpha[,1], prob=c(0.75)), t] = 1
  }
