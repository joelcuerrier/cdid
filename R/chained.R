...
#Muted on 5th of December. We don't use preprocess anymore. This function was initially use to configure the data to make the code copatible with Callaway's aggregated function.
...
resultat=chained_estimPeriod_Boot(yname=yname,
  ...
  #Muted on 5th of December. We use the ATT from Christophe's aggregated function
