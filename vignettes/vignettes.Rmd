...
# Simulate data
data0 = fonction_simu_attrition(theta2_alpha_Gg=0, factor = 0.5, lambda1_alpha_St=0, sigma_alpha=2, sigma_epsilon=0.5, alpha_percentile=1)
source("R/fonction_simu_attrition.R")
View(data0)


data0 <- data0[data0$P_Y1_longDID == 1,]
  data0 <- data0 %>%
    group_by(id) %>%
